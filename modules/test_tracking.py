...
class TrackPoints:
    ...
    def get_first_points(self, prev_frame, curr_frame):
        ...
        track_point_candidates = self.face.get_roi_of_face(prev_frame)
    ...
    def filter_none_face(self, curr_frame):
        ...
        face_rect = self.face.detect(curr_frame)
        mask = self.face.get_mask(curr_frame, face_rect)
...
if __name__ == "__main__":
    ...
    capture = cv2.VideoCapture("/tmp/test2.mp4")
    frame_c = 0
    gray_frames = [] 
